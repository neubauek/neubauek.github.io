(function() {
	...
	o.bullet = /(?:[*+-]|\d+\.)/, o.item = /^( *)(bull) [^\n]*(?:\n(?!\1bull )[^\n]*)*/, o.item = r(o.item, "gm")(/bull/g, o.bullet)(), o.list = r(o.list)(/bull/g, o.bullet)("hr", /\n+(?=(?: *[-*_]){3,} *(?:\n+|$))/)(), o._tag = "(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:/|@)\\b", o.html = r(o.html)("comment", /<!--[\s\S]*?-->/)("closed", /<(tag)[\s\S]+?<\/\1>/)("closing", /<tag(?:"[^"]*"|'[^']*'|[^'">])*?>/)(/tag/g, o._tag)(), o.paragraph = r(o.paragraph)("hr", o.hr)("heading", o.heading)("lheading", o.lheading)("blockquote", o.blockquote)("tag", "<" + o._tag)("def", o.def)(), o.normal = a({}, o), o.gfm = a({}, o.normal, {
		...
		for (var n, s, r, i, a, l, h, c, u, e = e.replace(/^ +$/gm, ""); e;)
	...
	h._inside = /(?:\[[^\]]*\]|[^\]]|\](?=[^\[]*\]))*/, h._href = /\s*<?([^\s]*?)>?(?:\s+['"]([\s\S]*?)['"])?\s*/, h.link = r(h.link)("inside", h._inside)("href", h._href)(), h.reflink = r(h.reflink)("inside", h._inside)(), h.normal = a({}, h), h.pedantic = a({}, h.normal, {
		...
		for (var t, n, r, i, a = ""; e;)
			...
			else if (i = this.rules.autolink.exec(e)) e = e.substring(i[0].length), "@" === i[2] ? (n = ":" === i[1][6] ? this.mangle(i[1].substring(7)) : this.mangle(i[1]), r = this.mangle("mailto:") + n) : (n = s(i[1]), r = n), a += '<a href="' + r + '">' + n + "</a>";
		else if (i = this.rules.url.exec(e)) e = e.substring(i[0].length), n = s(i[1]), r = n, a += '<a href="' + r + '">' + n + "</a>";
		else if (i = this.rules.tag.exec(e)) e = e.substring(i[0].length), a += this.options.sanitize ? s(i[0]) : i[0];
		else if (i = this.rules.link.exec(e)) e = e.substring(i[0].length), a += this.outputLink(i, {
			href: i[2],
			title: i[3]
		});
		...
		} else if (i = this.rules.strong.exec(e)) e = e.substring(i[0].length), a += "<strong>" + this.output(i[2] || i[1]) + "</strong>";
		else if (i = this.rules.em.exec(e)) e = e.substring(i[0].length), a += "<em>" + this.output(i[2] || i[1]) + "</em>";
		else if (i = this.rules.code.exec(e)) e = e.substring(i[0].length), a += "<code>" + s(i[2], !0) + "</code>";
		else if (i = this.rules.br.exec(e)) e = e.substring(i[0].length), a += "<br>";
		else if (i = this.rules.del.exec(e)) e = e.substring(i[0].length), a += "<del>" + this.output(i[1]) + "</del>";
		else if (i = this.rules.text.exec(e)) e = e.substring(i[0].length), a += s(i[0]);
		else if (e) throw new Error("Infinite loop on byte: " + e.charCodeAt(0));
		return a
...
! function() {
		...
		! function() {
			for (var n = t.concat(s), a = [], l = {}, o = 0, h = n.length; h > o; ++o) {
				var c = n[o],
					u = c[3];
				if (u)
					for (var p = u.length; --p >= 0;) i[u.charAt(p)] = c;
				var d = c[1],
					g = "" + d;
			...
			l = function(e) {
				for (var t = e.sourceCode, o = e.basePos, c = [o, q], u = 0, p = t.match(r) || [], d = {}, g = 0, f = p.length; f > g; ++g) {
					...
					if ("string" == typeof x) m = !1;
						...
						var y = i[b.charAt(0)];
						if (y) v = b.match(y[1]), x = y[0];
						else {
							for (var k = 0; a > k; ++k)
								if (y = s[k], v = b.match(y[1])) {
									x = y[0];
									break
								} v || (x = q)
						}
	...
	function a(e, t, n) {
			...
			switch (e.nodeType) {
				case 1:
					...
					if ("br" === e.nodeName) r(e), e.parentNode && e.parentNode.removeChild(e);
						...
						for (var t = e.firstChild; t; t = t.nextSibling) s(t);
					break;
				case 3:
				case 4:
					if (n) {
		...
		function r(e) {
			...
			for (var n, s = t(e.nextSibling, 0);
				(n = s.parentNode) && 1 === n.nodeType;) s = n;
			h.push(s)
		}
		...
		for (var p = Math.max(0, t - 1 | 0) || 0, c = 0, d = h.length; d > c; ++c) o = h[c], o.className = "L" + (c + p) % 10, o.firstChild || o.appendChild(l.createTextNode(" ")), u.appendChild(o);
		e.appendChild(u)
	}
	...
	function p(e) {
		...
		for (var r = [t("pre"), t("code"), t("xmp")], i = [], l = 0; l < r.length; ++l)
			for (var o = 0, h = r[l].length; h > o; ++o) i.push(r[l][o]);
		r = null;
		var u = Date;
		u.now || (u = {
			now: function() {
...
function(e, t) {
	...
	p = p.toLowerCase(), console.log("[strapdown.js] [INFO] Parser and lexer well imported. Origin = " + o + "\n Theme = " + p);
	...
	*/
	...
	if (C.type = "text/x-mathjax-config", C.innerHTML = "MathJax.Hub.Config({ tex2jax: { inlineMath: [['$','$']], displayMath: [ ['$$','$$']], processEscapes: true } });", t.body.appendChild(C), u.mathjax) {
		var C = t.createElement("script");
		C.type = "text/javascript", C.src = "https://cdn.mathjax.org/mathjax/latest/MathJax.js?config=TeX-AMS_HTML&amp;locale=fr", t.head.appendChild(C)
	}
	if (u.beacon) {
		var d = t.createElement("img");
		d.alt = "GA|Analytics", d.style = "visibility: hidden; display: none;", d.src = "http://perso.crans.org/besson/beacon/14/query/strapdown.js?pixel", t.body.appendChild(d)
	}
}(window, document);